...
export default function Footer() {
  ...
  const socialLinks = [
    { href: "https://facebook.com/sigmapi", label: "Facebook", icon: "facebook.svg" },
    { href: "https://twitter.com/sigmapi", label: "Twitter", icon: "twitter.svg" },
    { href: "https://instagram.com/sigmapi", label: "Instagram", icon: "instagram.svg" },
    { href: "https://youtube.com/sigmapi", label: "YouTube", icon: "youtube.svg" },
  ];
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 mb-4 md:mb-0">
            &copy; {currentYear} SigmaPi - All rights reserved.
          </p>
